...
class _DragNDropPageState extends State<DragNDropPage>
    ...
    var content = Column(
        ...
        children: <Widget>[
          Draggable(
            ...
            childWhenDragging:
                Icon(Icons.directions_run, size: 72, color: Colors.blue),
              ...
              if (accepted) {
                return GestureDetector(
                    ...
                    child: Container(
                        ...
                        child: Text('Acertô mizeravi!',
                            style: TextStyle(color: Colors.white))));
              } else {
                return Container(
                    color: Colors.black54,
                    padding: EdgeInsets.all(20),
                    child: Text('Arraste para cá!',
                        style: TextStyle(color: Colors.white)));
              }
            }, onWillAccept: (data) {
              print('1');
